Write-Host "=== Шаблон для нового предмета ===" -ForegroundColor Green
Write-Host ""
Write-Host "Скопируйте этот код и вставьте в массив 'subjects' в файле data.js"
Write-Host ""
Write-Host "Место для вставки: между другими предметами в массиве [ ... ]"
Write-Host ""
...
<head>
    ...
    <link rel="stylesheet" href='assets/css/admin.css?v=202512030024'>
...
<body>
    ...
    <script>
        ...
        // Сохраняем состояние админки в localStorage
 ...
 = Get-Content "assets/js/data.js" -Raw
if (
<!DOCTYPE html>
<html lang="ru">
<head>
...
<body>
 ...
 -match 'let subjects = (\[.*?\}\]\s*\];)') {
     = System.Collections.Hashtable[1] -replace 'let subjects = ','' -replace ';$',''
     =  | ConvertFrom-Json
     = ( | Measure-Object -Property id -Maximum).Maximum + 1
} else {
     = 6
}
...
Write-Host "        name: "Новый предмет"," -ForegroundColor Yellow
Write-Host "        teacher: "Имя преподавателя"," -ForegroundColor Yellow
Write-Host "        files: []" -ForegroundColor Gray
Write-Host "    }," -ForegroundColor Gray

Write-Host ""
Write-Host "Инструкция:" -ForegroundColor Green
Write-Host "1. Откройте https://github.com/U007U/Syte/edit/main/assets/js/data.js"
Write-Host "2. Найдите массив 'subjects' (примерно строки 8-60)"
Write-Host "3. Вставьте шаблон выше в нужное место"
Write-Host "4. Измените название и преподавателя"
Write-Host "5. Сохраните (Commit changes)"
